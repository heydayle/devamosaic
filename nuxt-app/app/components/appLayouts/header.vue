    ...
    <ClientOnly>
      ...
      >
        <div class="container px-4 flex justify-between items-center">
          <AppLogo class="flex-1" />
          <div class="flex flex-1 justify-end items-center space-x-2">
            <UColorModeButton />
            <UButton :to="github.href" variant="ghost" color="neutral" class="cursor-target text-xl">
              <UIcon :name="github.icon" size="22" class="text-xl"/>
            </UButton>
            <UButton to="https://thinh.io.vn" variant="ghost" color="neutral" class="cursor-target text-2xl">
              thinh
            </UButton>
          </div>
        </div>
